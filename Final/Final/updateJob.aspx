<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateJob.aspx.cs" Inherits="Final.updateJob" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="section-heading">
            <div class="vertically-align-center width-100p">
                <h3>Update<span class="primary-color"> Job</span></h3>
         ...
         <div class="form-container">
            <span class="fas fa-sign-in-alt"></span>
             ...
             &nbsp;<asp:Button  CssClass="flat-button  mx-auto my-10"  ID="updateJobSubmit" runat="server" Text="Update Job" OnClick="updateJobSubmit_Click" />
